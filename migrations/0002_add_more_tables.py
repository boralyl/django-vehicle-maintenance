...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vehicle_occurrence', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('num_days', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('vehicle', ['Occurrence'])

        # Adding model 'MaintenanceItem'
        db.create_table('vehicle_maintenanceitem', (
            ('check_occurrence', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vehicle.Occurrence'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('procedure', self.gf('django.db.models.fields.TextField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=75)),
        ))
        db.send_create_signal('vehicle', ['MaintenanceItem'])

        # Adding model 'MaintenanceItemCheck'
        db.create_table('vehicle_maintenanceitemcheck', (
            ('notes', self.gf('django.db.models.fields.TextField')()),
            ('maintenance_item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vehicle.MaintenanceItem'])),
        ...
        db.send_create_signal('vehicle', ['MaintenanceItemCheck'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Occurrence'
        db.delete_table('vehicle_occurrence')

        # Deleting model 'MaintenanceItem'
        db.delete_table('vehicle_maintenanceitem')

        # Deleting model 'MaintenanceItemCheck'
        db.delete_table('vehicle_maintenanceitemcheck')
